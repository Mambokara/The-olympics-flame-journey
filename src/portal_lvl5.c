...
static portal_pos_t **fill_struct_portal_lvl5(void)
{
...
static void fill_struct_portal_isteleportor_lvl5(portal_t *portal)
{
...
static void create_rectangle_colision_lvl5(portal_t *portal)
{
...
portal_t *portal_lvl5(void)
{
    ...
    portal->portal_pos = fill_struct_portal_lvl5();
    fill_struct_portal_isteleportor_lvl5(portal);
    create_rectangle_colision_lvl5(portal);
