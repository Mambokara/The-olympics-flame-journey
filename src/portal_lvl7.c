...
static portal_pos_t **fill_struct_portal_lvl7(void)
{
...
static void fill_struct_portal_isteleportor_lvl7(portal_t *portal)
{
...
static void create_rectangle_colision_lvl7(portal_t *portal)
{
