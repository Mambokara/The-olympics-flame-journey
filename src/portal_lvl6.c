...
static portal_pos_t **fill_struct_portal_lvl6(void)
{
...
static void fill_struct_portal_isteleportor_lvl6(portal_t *portal)
{
...
static void create_rectangle_colision_lvl6(portal_t *portal)
{
...
portal_t *portal_lvl6(void)
{
    ...
    portal->portal_pos = fill_struct_portal_lvl6();
    fill_struct_portal_isteleportor_lvl6(portal);
    create_rectangle_colision_lvl6(portal);
